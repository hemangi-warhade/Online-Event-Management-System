...
<div class="form-bg">
    ...
    <div class="login-form">
        <form method="post">
            ...
            <input type="submit" name="btn-login" class="btn-login" value="Login" style="margin:0px 0px"/>
        </form>
    </div>
</div><br />

    <h3>New User?</h3>
    <a href="register.php"><button type="button" class="btn-b" style="margin:0px 510px"/>Register Here</button></a><br /><br />	
